        ...
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="admin.php">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center"><img src="assets/img/logo/pac-logo.png" alt="phoenix" width="27" />
                        <h5 class="logo-text ms-2 d-none d-sm-block fw-bold">LMS</h5>
                    </div>
                </div>
            </a>
        </div>
